...
public class Disease implements Cloneable {
    ...
    private long diseaseID; // Cloned diseases will have the same ID - used to make sure bots cannot have
                            // more than one of the same disease.
    ...
    public Disease() {
        ...
        fatalityLevel = 0; // current level of seriousness. If it reaches FATALITYNUMBER, the bot should be
                           // terminated
    ...
    private Disease(long diseaseID, boolean contagious, double probabilityOfSpread, int fatalityLevel,
    ...
    public Disease clone() {
        return new Disease(this.diseaseID, this.contagious, this.probabilityOfSpread, this.fatalityLevel,
